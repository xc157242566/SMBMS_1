...
function deleteProvider(obj){
	$.ajax({
		type:"GET",
		url:path+"/jsp/providerdelprovider",
...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		$.ajax({
			type:"POST",
			url:path+"/jsp/providerinfo",
			data:{proid:obj.attr("proid")},
			dataType:"json",
			success:function(data){
				$("#providerinfo #proCode").val(data.proCode)
				$("#providerinfo #proName").val(data.proName)
				$("#providerinfo #proContact").val(data.proContact)
				$("#providerinfo #proPhone").val(data.proPhone)
				$("#providerinfo #proAddress").val(data.proAddress)
				$("#providerinfo #proFax").val(data.proFax)
				$("#providerinfo #proDesc").val(data.proDesc)				
			},
			error:function(data){
				alert("对不起，查看失败");
			}
